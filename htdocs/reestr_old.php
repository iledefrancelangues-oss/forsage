...
try {
    // Завершаем лоты, время которых истекло без победителя
    ...
    // Помечаем как 'single' лоты, где была единственная победная ставка
...
// дальше твои фильтры $filter_status...
...
if ($filter_status === 'active') {
    ...
    $where[] = "l.auction_status IN ('finished','failed','cancelled')";
